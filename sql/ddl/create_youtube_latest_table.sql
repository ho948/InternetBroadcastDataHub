...
CREATE TABLE IF NOT EXISTS youtube.latest_video_with_rank (
    rank INT,
...
CREATE TABLE IF NOT EXISTS youtube.latest_weekly_views_count (
...
CREATE TABLE IF NOT EXISTS youtube.latest_channel_name_latest (
    channel_link VARCHAR(255) PRIMARY KEY,
    channel_name VARCHAR(255),
    created_at TIMESTAMP DEFAULT NOW(),
    updated_at TIMESTAMP DEFAULT NOW()
);
CREATE TABLE IF NOT EXISTS youtube.latest_channel_video (
    channel_name VARCHAR(255),
...
CREATE TABLE IF NOT EXISTS youtube.latest_channel_live_time_to_trending (
    channel_name VARCHAR(255),
    video_link VARCHAR(255),
